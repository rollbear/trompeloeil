...
//      REQUIRE(reports.front().msg = ~crpcut::regex("Sequence mismatch.*seq2.*of obj2.count().*has obj1.count().*first"));
  ...
  TEST_CASE_METHOD(Fixture, "lr return access copy of local object", "[return values]")
  {
    int n = 1;
    mock_c obj;
    REQUIRE_CALL(obj, getter(ANY(int)))
  ...
  TEST_CASE_METHOD(Fixture, "return by reference returns object given", "[return values]")
  {
    {
      mock_c obj;
      unmovable s;
  ...
  TEST_CASE_METHOD(Fixture, "return param by reference returns object given", "[return values]")
  {
    {
      mock_c obj;
      unmovable s;
  ...
  TEST_CASE_METHOD(Fixture, "lr_with matches reference to local object", "[matching]")
  {
    mock_c obj;
    int n = 1;
    REQUIRE_CALL(obj, getter(ANY(int)))
  ...
  TEST_CASE_METHOD(Fixture, "rvalue reference parameter can be compared with nullptr", "[matching]")
  {
    {
      mock_c obj;
  ...
  TEST_CASE_METHOD(Fixture, "rvalue reference parameter can be compared with external value", "[matching]")
  {
    {
      mock_c obj;
      auto pi = new int{ 3 };
 ...
 0x40 0x41 0x42 0x43 0x44 0x45 0x46 0x47 0x48 0x49 0x4a 0x4b 0x4c 0x4d 0x4e 0x4f
  ...
  TEST_CASE_METHOD(Fixture, "wildcards matches overload on type and parameter count", "[overloads]")
  {
    {
      mock_c obj;
...
Expected obj.foo("bar") to be called once, actually never called
  ...
  TEST_CASE_METHOD(Fixture, "an unexpected destruction of monitored object is reported", "[destruction]")
  {
    {
  ...
  TEST_CASE_METHOD(Fixture, "an expected destruction of monitored object is not reported", "[destruction]")
  {
    {
  ...
  TEST_CASE_METHOD(Fixture, "a copy of a deathwatched object with expectation is not expected to die", "[destruction]")
  {
  ...
  TEST_CASE_METHOD(Fixture, "a deathwatched object move constructed from original with expectation is not expected to die and the original still is", "[destruction]")
  {
    auto orig = new trompeloeil::deathwatched<none>;
    REQUIRE_DESTRUCTION(*orig);
  ...
  TEST_CASE_METHOD(Fixture, "object alive when destruction expectation goes out of scope is reported", "[destruction]")
  {
    trompeloeil::deathwatched<mock_c> obj;
    {
  ...
  TEST_CASE_METHOD(Fixture, "require destruction succeeds also without deathwatch", "[destruction]")
  {
    {
      auto obj = new trompeloeil::deathwatched<mock_c>;
      REQUIRE_DESTRUCTION(*obj);
  ...
  TEST_CASE_METHOD(Fixture, "a deathwatched objects constructor passes params to mock", "[destruction]")
  {
  ...
  TEST_CASE_METHOD(Fixture, "parameters are passed in correct order to SIDE_EFFECT", "[parameters]")
  {
    T obj;
    int n = 0;
    REQUIRE_CALL(obj, concats(_, _, _, _, _, _, _, _, _, _, _, _, _, _, _))
